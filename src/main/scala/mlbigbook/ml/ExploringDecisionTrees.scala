...
//  //    def continuous[D[_] : Data, N: NumericConversion, V[_]](c: C)(data: D[V[N]])(implicit fs: FeatureSpace[N,V]): V[Double]
//  //  }
//
...
//  //
//  //    def continuous[D[_] : Data, N : NumericConversion, V[_]](data: D[V[N]])(implicit fs: FeatureSpace[N, V]) = {
//  //
//  //      import fs._
...
//  }
//
//  @typeclass trait VectorHofs[V[_]] {
//
...
//
//    def apply[V[_]: VectorHofs]: VectorHofs[V] =
...
//
//  // TODO delete me
//  def test[V[_]: VectorHofs](v: V[Double]): V[Double] = {
