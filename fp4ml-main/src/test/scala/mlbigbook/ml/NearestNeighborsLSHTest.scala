...
//import mlbigbook.data.{ OLD_VectorizerMaker, OLD_Vectorizer, OLD_VectorizerMaker$, OLD_Vectorizer$ }
...
//
//  def addressVectorizer[N: Fractional]: OLD_Vectorizer[Address[N]] =
//    (a: Address[N]) =>
//      DenseVector(Array(implicitly[Numeric[N]].toDouble(a.loc.x), implicitly[Numeric[N]].toDouble(a.loc.y)))
//
//  def mkAddressVectorizer[N](implicit n: Fractional[N]): OLD_VectorizerMaker[Address[N]] =
//    ???
//
//}
//
